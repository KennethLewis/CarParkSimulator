...
public class CarParkTests {
	...
	private static final int EXAMPLE_DEPARTURE_TIME = EXAMPLE_ARRIVAL_TIME
	...
	public void testCreateTestCarPark() throws VehicleException {
		...
		testTinyPark = new CarPark(EXAMPLE_SPACES_TINY,
				EXAMPLE_SMALL_SPACES_TINY, EXAMPLE_CYCLE_SPACES_TINY,
				EXAMPLE_QUEUE_SIZE);
	...
	/**
	 * Tests if the car park is correctly returning true when it is empty
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 */
	...
	/**
	 * Tests if the car park is correctly returning false when it is not empty
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	...
	public void testEmptyCarPark_False() throws VehicleException,
			SimulationException {
		testCarPark.parkVehicle(testCar, EXAMPLE_ARRIVAL_TIME,
				EXAMPLE_INTENDED_DURATION);
		assertFalse(testCarPark.carParkEmpty());
	}

	/**
	 * Tests if the car park is correctly returning true when it is full
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	...
	public void testFullCarPark() throws VehicleException, SimulationException {
		...
		testTinyPark.parkVehicle(testCar, testCar.getArrivalTime(),
				EXAMPLE_INTENDED_DURATION);
	...
	/**
	 * Tests if the car park is correctly returning false when it is not full
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testFullCarPark_False() throws VehicleException,
			SimulationException {
	...
	/**
	 * Tests if an exception is throw when we try adding a car to a full carpark
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	...
	public void testParkVehicle_Duplicate() throws VehicleException,
			SimulationException {
		testCarPark.parkVehicle(testCar, testCar.getArrivalTime(),
				EXAMPLE_INTENDED_DURATION);
		testCarPark.parkVehicle(testCar, testCar.getArrivalTime(),
				EXAMPLE_INTENDED_DURATION);
	}
	...
	public void testParkVehicle_NoSpaces() throws VehicleException,
			SimulationException {
		testTinyPark.parkVehicle(testCar, testCar.getArrivalTime(),
				EXAMPLE_INTENDED_DURATION);
	...
	/**
	 * Tests if we can correctly get the number of cars in the carpark
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	...
	/**
	 * Tests if we can correctly get the number of small cars in the carpark
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @author Ken Lewis
	...
	/**
	 * Tests if we can correctly get the number of motorcycles in the carpark
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testNumMotorCycles() throws VehicleException,
			SimulationException {
		...
		for (int i = 0; i < EXAMPLE_LOOP; i++) {
			testCarPark.parkVehicle(testBike, testBike.getArrivalTime(),
					EXAMPLE_INTENDED_DURATION);
			testBike = new MotorCycle(EXAMPLE_PLATE, EXAMPLE_ARRIVAL_TIME);
		}
	...
	/**
	 * Tests if we can add a car to the queue and correctly get number of
	 * vehicles
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test
	public void testQueueNumVehicles() throws VehicleException,
			SimulationException {
	 ...
	 */
	@Test
	public void testQueueNumVehicles_Empty() throws VehicleException,
			SimulationException {
	 ...
	 */
	@Test
	public void testQueueFull_False() throws VehicleException,
			SimulationException {
		testCarPark.enterQueue(testCar);
	 ...
	 */
	@Test
	public void testQueueEmpty_False() throws VehicleException,
			SimulationException {
		testCarPark.enterQueue(testCar);
	 ...
	 */
	@Test
	public void testRemoveFromCarpark() throws VehicleException,
			SimulationException {
		testCarPark.parkVehicle(testCar, testCar.getArrivalTime(),
				EXAMPLE_INTENDED_DURATION);
	...
	/**
	 * Tests if an exception is thrown when we try to remove a car from a
	 * carpark when it isn't in there
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testRemoveFromCarpark_WithoutBeingParked()
	...
	/**
	 * Tests if it is calculated that there is no space for a normal car when
	 ...
	 */
	@Test
	public void testSpacesAvailable_Full_Car() throws VehicleException,
			SimulationException {
	...
	/**
	 * Tests if it is calculated that there is no space for a small car when all
	 * spaces are filled
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test
	public void testSpacesAvailable_Full_SmallCar() throws VehicleException,
			SimulationException {
	...
	/**
	 * Tests if it is calculated that there is no space for a bike when all
	 * spaces are filled
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test
	public void testSpacesAvailable_Full_Bike() throws VehicleException,
			SimulationException {
	...
	/**
	 * Tests if it is calculated that is space for a bike when there is in fact
	 * space
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test
	public void testSpacesAvailable_Bike() throws VehicleException,
			SimulationException {
	...
	/**
	 * Tests if it is calculated that is space for a car when there is in fact
	 * space
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test
	public void testSpacesAvailable_Car() throws VehicleException,
			SimulationException {
	...
	/**
	 * Tests if it is calculated that is space for a small car when there is in
	 * fact space
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test
	public void testSpacesAvailable_SmallCar() throws VehicleException,
			SimulationException {
	...
	/**
	 * Tests if it is calculated that is space for a small car when there is in
	 * fact space (a normal space that is)
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testSpacesAvailable_SmallCar_InBigSpace()
			throws VehicleException, SimulationException {
	...
	/**
	 * Tests if it is calculated that is space for a bike when there is in fact
	 * space (a small car space that is)
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testSpacesAvailable_Bike_InBigSpace() throws VehicleException,
			SimulationException {
	...
	/**
	 * Test if small cars are overflowing into normal spaces and properly
	 * blocking normal cars
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testSpacesAvailable_Car_CantFromOverflow()
			throws VehicleException, SimulationException {
	...
	/**
	 * Tests if an exception is thrown when we try to archive a vehicle that
	 * isn't 'new', since it's parked already
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test(expected = SimulationException.class)
	public void testArchiveNewVehicle_Parked() throws SimulationException,
			VehicleException {
	...
	/**
	 * Tests if an exception is thrown when we try to archive a vehicle that
	 * isn't 'new', since it's queued already
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test(expected = SimulationException.class)
	public void testArchiveNewVehicle_Queued() throws SimulationException,
			VehicleException {
		testCarPark.enterQueue(testCar);
		testCarPark.archiveNewVehicle(testCar);
	}
	...
	public void testArchiveNewVehicle() throws SimulationException,
			VehicleException {
		testCarPark.archiveNewVehicle(testCar);
		assertTrue(testCarPark.getStatus(testCar.getArrivalTime()).contains(
				"A:1"));
	}

	/**
	 * Tests if new vehicles that are archived are truly 'new', by verifying
	 * that they were never queued
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testArchiveNewVehicle_NeverQueued() throws SimulationException,
			VehicleException {
		testCarPark.archiveNewVehicle(testCar);
	 ...
	 */
	@Test
	public void testArchiveNewVehicle_NeverParked() throws SimulationException,
			VehicleException {
		testCarPark.archiveNewVehicle(testCar);
	...
	/**
	 * Tests if parked departing vehicles are correctly cleared (if set to do
	 * so) at end of the day
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testArchiveDepartingVehicles_ForceClear()
	 ...
	 */
	@Test(expected = VehicleException.class)
	public void testArchiveDepartingVehicles_IntendedTooShort()
			throws SimulationException, VehicleException {
		testCarPark.parkVehicle(testCar, EXAMPLE_ARRIVAL_TIME,
	...
	/**
	 * Tests if this method doesn't archive the vehicle if the vehicle hasn't
	 * been in the queue long enough
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testArchiveQueueFailures_NotLongEnough()
			throws SimulationException, VehicleException {
	...
	/**
	 * Tests if exception is thrown when vehicle is added to a queue with a max
	 * size of 0
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test(expected = SimulationException.class)
	public void testEnterQueue_Full_ZeroQueue() throws SimulationException,
			VehicleException {
		testCarPark = new CarPark(EXAMPLE_SPACES, EXAMPLE_SMALL_SPACES,
				EXAMPLE_CYCLE_SPACES, 0);
		testCarPark.enterQueue(testCar);
	}
	 ...
	 */
	@Test(expected = SimulationException.class)
	public void testEnterQueue_Full() throws SimulationException,
			VehicleException {
		for (int i = 0; i < EXAMPLE_QUEUE_SIZE; i++) {
			Car testCar = new Car(EXAMPLE_PLATE, EXAMPLE_ARRIVAL_TIME, false);
			testCarPark.enterQueue(testCar);
	...
	/**
	 * Tests if exception is thrown when we attempt to remove a car from the
	 * queue that doesn't exist in the queue
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test(expected = SimulationException.class)
	public void testExitQueue_NotInQueue() throws SimulationException,
			VehicleException {
		testCarPark.exitQueue(testCar, EXAMPLE_DEPARTURE_TIME);
	}

	/**
	 * Tests if a new car is created and added to the carpark. Probability is
	 * set to certain in order to test for this.
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testTryProcessNew_Park() throws SimulationException,
			VehicleException {
		Simulator sim = new Simulator(Constants.DEFAULT_SEED,
				Constants.DEFAULT_INTENDED_STAY_MEAN,
				Constants.DEFAULT_INTENDED_STAY_SD, EXAMPLE_PROB_CERTAIN, 0, 0);
		testCarPark.tryProcessNewVehicles(EXAMPLE_SIM_TIME, sim);
		assertTrue(testCarPark.getStatus(EXAMPLE_SIM_TIME).contains("C:1"));
	}

	/**
	 * Tests if a new car is created and added to the queue. Probability is set
	 * to certain in order to test for this.
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 * @throws SimulationException
	 */
	@Test
	public void testTryProcessNew_Queue() throws SimulationException,
			VehicleException {
		Simulator sim = new Simulator(Constants.DEFAULT_SEED,
				Constants.DEFAULT_INTENDED_STAY_MEAN,
				Constants.DEFAULT_INTENDED_STAY_SD, EXAMPLE_PROB_CERTAIN, 0, 0);
	...
	/**
	 * Tests if a new car is created and added to the archive. Probability is
	 * set to certain in order to test for this.
	 * 
	 * @throws VehicleException
	 * @author Thomas McCarthy
	 ...
	 */
	@Test
	public void testTryProcessNew_ArchiveInstantly()
			throws SimulationException, VehicleException {
		Simulator sim = new Simulator(Constants.DEFAULT_SEED,
				Constants.DEFAULT_INTENDED_STAY_MEAN,
				Constants.DEFAULT_INTENDED_STAY_SD, EXAMPLE_PROB_CERTAIN, 0, 0);
		...
		testTinyPark = new CarPark(EXAMPLE_SPACES_TINY,
				EXAMPLE_SMALL_SPACES_TINY, EXAMPLE_CYCLE_SPACES_TINY, 0);
